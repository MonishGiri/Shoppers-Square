    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ((String) hs.getAttribute("name") == null) {
                ...
                int addToCart = DatabaseConnection.insertUpdateFromSqlQuery("insert into tblcart(discount_price,quantity,total_price,customer_id,product_id,mrp_price) values('" + price + "',1,'" + price + "','" + customerId + "','" + productId + "','" + mrp_price + "')");
                if (addToCart > 0) {
