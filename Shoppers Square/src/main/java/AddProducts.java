        ...
        if (ServletFileUpload.isMultipartContent(request)) {
            try {
                ...
                try {
                    ...
                    String url = "jdbc:sqlserver://localhost:1433;databaseName=shoppingsystem";
            		String user = "sa";
            		String password = "123";
                        ...
                        PreparedStatement ps = connection.prepareStatement("insert into tblproduct(active,code,description,image,image_name,name,price,mrp_price,product_category) values (?,?,?,?,?,?,?,?,?)");
                        ...
                        ps.setString(8, mrpPrice);
                        ps.setNString(9, category);
                        ps.executeUpdate();
                        i = 1;
