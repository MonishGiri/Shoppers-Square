                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <%
                            ...
                            ResultSet totolAmount = DatabaseConnection.getResultFromSqlQuery("select sum(convert(int,total_price)), sum(convert(int,mrp_price)) from tblcart where customer_id= " + session.getAttribute("id"));
                            if (totolAmount.next()) {
                    ...
                    <div>
                        ...
                        <div>
                            <%
                                ...
                                if (rsPaymentId.next()) {
                                    paymentId = rsPaymentId.getInt(1);
                                    paymentId++;
                                }
                            %>
