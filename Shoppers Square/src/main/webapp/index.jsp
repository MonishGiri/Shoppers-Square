            ...
            <div class="slide-visual">
                ...
                <div class="script-wrap">
                    ...
                    <div class="slide-controller">
                        <a href="#" class="btn-prev"><i class="fa-solid fa-angles-left fa-2x"></i></a> <a href="#" class="btn-play"><i class="fa-solid fa-play fa-2x"></i></a> <a href="#"
                                                                              class="btn-pause"><i class="fa-solid fa-pause fa-2x"></i></a> <a href="#" class="btn-next"><i class="fa-solid fa-angles-right fa-2x"></i></a>
                    </div>
                </div>
                <div class="clearfix"></div>
            </div>
